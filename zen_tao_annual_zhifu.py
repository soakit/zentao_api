        ...
        for project_id in [project_id]:  # 遍历1, 18, 27
            for condition in ranges:  # 循环区间
                ...
                for item in json_query_data['bugs']:
                    ...
                    # 支付pod：符丽(fuli)、陈丰祥(chenfx)、李可柑(likg)、孙瑶(sunyao)
                    employees = ['fuli', 'chenfx', 'likg', 'sunyao']
...
if __name__ == "__main__":
    # 创建参数解析器
    parser = argparse.ArgumentParser(description='支付pod生产bug统计')
