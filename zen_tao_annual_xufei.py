        ...
        for project_id in [project_id]:  # 遍历1, 18, 27
            for condition in ranges:  # 循环区间
                ...
                for item in json_query_data['bugs']:
                    ...
                    # 续费团队：胡于辉(huyh)、刘畅(liuchang)、伍官华(wugh)、邓锦坤(dengjk)、谢启才(xieqc)、王凯霞(wangkx)、詹炜权(zhanwq)
                    employees = ['huyh', 'liuchang', 'wugh', 'dengjk', 'xieqc', 'wangkx', 'zhanwq']
...
if __name__ == "__main__":
    # 创建参数解析器
    parser = argparse.ArgumentParser(description='续费团队生产bug统计')
